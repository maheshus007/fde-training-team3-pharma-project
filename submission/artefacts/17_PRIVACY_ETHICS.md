...
| Status | Reviewed |
| Related requirements / ADRs | INJ-041, INJ-059, INJ-060, INJ-061, INJ-064; D-401; A-401..A-403 |
...
|---|---|---|---|---|
| E-1701 | `case/INTEGRATED_CASE.md` INJ-041, INJ-059..061, INJ-064 | Case inject catalogue | Privacy conflict narratives | Narrative |
...
| Item / question | Evidence-based response | Decision / owner | Acceptance evidence |
|---|---|---|---|
| Sensitive segments (INJ-041) | Pregnancy/paediatric content requires elevated role; general case queue must not expose by default | Privacy + PV | E-1706 |
...
| Sensitive segments (INJ-041) | Elevated role gate | Access tests (later) | E-1706 | Design accepted |
