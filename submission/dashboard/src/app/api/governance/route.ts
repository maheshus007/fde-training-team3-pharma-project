...
import { boundaryDoes, boundaryNever, continuityMetrics, hardGates } from "@/lib/data";
...
export function GET(request: NextRequest) {
  ...
  return NextResponse.json({ product: product.data, timeRange, hardGates, continuityMetrics, boundaryDoes, boundaryNever });
}
