...
Per `WORKSHOP_DEPLOYMENT_PLAN.md` **Stage 2**, write feature/AC/BR content only into:

- `submission/artefacts/09_REQUIREMENTS_TRACEABILITY.md`

Do **not** create per-feature FR files, Stage 3+ artefacts, or separate AC registers. Tests under `submission/tests/` come in later stages.
